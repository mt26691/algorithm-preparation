...
namespace BinaryTree._08.PostOrderTravesal
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            PostOrderTraverse(binayTree.Root);
            Console.ReadLine();
        }

        public static void PostOrderTraverse<T>(BinaryTreeNode<T> rootNode) where T : IComparable<T>
        {
            if (rootNode == null)
            {
                return;
